...
{
    return [[UIStoryboard storyboardWithName:@"MiSnapUX2" bundle:[NSBundle bundleForClass:MiSnapSDKViewControllerUX2.self]] instantiateViewControllerWithIdentifier:[MiSnapSDKViewControllerUX2 storyboardIdentifier]];
}
